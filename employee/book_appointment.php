...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Activate the "Doctor Availability" tab by default
...
<div class="container">
    <div class="tabs">
        <div class="tab active" data-target="availability">Doctor Availability</div>
    </div>
    ...
    <div class="tab-content active" id="availability">
        ...
        <form action="" method="post">
            <table>
                ...
                <?php
                $query2 = "SELECT Time, Day, doctors.doctorName, registration.lname, registration.fname, doctors.specialization 
                           FROM Availability 
                ...
                while ($row = $statement->fetch_assoc()) {
                    ...
                    echo "<td><a href='lab_result_submission_form.php'><button type='button' class='back_btn'>Upload Notes</button></a></td>";
                    echo "</tr>";
                    $count++;
                }
                ?>
        ...
        if (isset($_POST['book'])) {
            ...
            $query3 = "UPDATE Availability 
                       SET Status = 'Reserved', healthNo='$patientno' 
