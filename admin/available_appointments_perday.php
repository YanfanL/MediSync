...
<body class="user_report_container">
    ...
    $sql = "SELECT COUNT(*) AS count FROM `availability` WHERE `Day` = '$selected_day' AND `Status` = 'Available'";
    ...
    <?php
    if ($selected_day) {
        echo "<p>Number of available appointments on $selected_day: $appointment_count</p>";
    }
    ?>
